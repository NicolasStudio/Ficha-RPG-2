...
//Se eu clicar no botão vai existir uma variavel SUBMIT, ele salva no banco de dado.
    if(isset($_POST['submit1'])){
        ...
        // eu verifico se a pessoa logada esta no banco
                    ...
                    if (($resultado_usuario) AND ($resultado_usuario->num_rows != 0 )){
                        while($row_usuario = mysqli_fetch_assoc($resultado_usuario)){
                            ...
                            if ($logado == $row_usuario ['email']){
                                ...
                                $dinheiro = $row_usuario['valorDinheiro']; 
    ...
    <!--------- PERÍCIAS --------->  
        ...
        <div class="blackSaude">
            ...
            <div class="posicaoEsforco">
                ...
                <input type="text" id="esforMax" value="<?php echo $esforcoPre ?>" class="pontosEsforcoMax" placeholder="Não preencher" name="esforMax">
        ...
        <div class="blackDefesa">
            ...
            <div class="posicaoDef">
                ...
                <input type="text" id="passiva" class="pontosDEF" value="<?php echo $passivaAgi ?>" name="passiva" placeholder="Não preencher">

            <!-- ESQUIVA --> 
            <div class="posicaoEsq">
                <P class="txtEsq"> ESQUIVA </P><br>
            </div>
                <input type="text" id="esquiva" class="pontosEsq" value="<?php echo $esquivaReflexo ?>" name="esquiva" placeholder="Não preencher">
             ...
             <div class="boxArmas">
                <P class="txtBox"> ------ Arma ------ Tipo ------ Ataque ------ Alcance ------ Dano ------ Critico ------ Recarga ------ Especial ------</p>
                    <input type="text" value="<?php echo $arma1 ?>" id="arma1" class="bxL linha1" name="arma1"><br>
                    <input type="text" value="<?php echo $arma2 ?>" id="arma2" class="bxL linha2" name="arma2"><br>
                    <input type="text" value="<?php echo $arma3 ?>" id="arma3" class="bxL linha3" name="arma3"><br>
                    <input type="text" value="<?php echo $arma4 ?>" id="arma4" class="bxL linha4" name="arma4"><br>
                    <input type="text" value="<?php echo $arma5 ?>" id="arma5" class="bxL linha5" name="arma5"><br>
            </div>
            ...
            <div class="somaPesoEspaco">
                <p class="txtMensagem">O total de espaços vazios são: 
            ...
            <div class="boxCarac">
                ...
                <textarea name="textoCaract"  id="textoCaract" class="blocoCarac" placeholder="Descreva suas características, habilidas, manias, hobbies, sua motivação e afins: ">
                <?php echo $textoCaract?>
            ...
            <div class="boxHab">
                <textarea name="textohabi"  id="textohabi" class="blocoHab" placeholder="Digite a habilidade da ORIGEM escolhida e as adquiridas: ">
                <?php echo  $textohabi?>
